...
export const SetChainlinkPriceEvent = {
    ...
    create(base) {
        return SetChainlinkPriceEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseSetChainlinkPriceEvent();
...
export const SetBandPriceEvent = {
    ...
    create(base) {
        return SetBandPriceEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseSetBandPriceEvent();
...
export const SetBandIBCPriceEvent = {
    ...
    create(base) {
        return SetBandIBCPriceEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const EventBandIBCAckSuccess = {
    ...
    create(base) {
        return EventBandIBCAckSuccess.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseEventBandIBCAckSuccess();
...
export const EventBandIBCAckError = {
    ...
    create(base) {
        return EventBandIBCAckError.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseEventBandIBCAckError();
...
export const EventBandIBCResponseTimeout = {
    ...
    create(base) {
        return EventBandIBCResponseTimeout.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseEventBandIBCResponseTimeout();
...
export const SetPriceFeedPriceEvent = {
    ...
    create(base) {
        return SetPriceFeedPriceEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseSetPriceFeedPriceEvent();
...
export const SetProviderPriceEvent = {
    ...
    create(base) {
        return SetProviderPriceEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseSetProviderPriceEvent();
...
export const SetCoinbasePriceEvent = {
    ...
    create(base) {
        return SetCoinbasePriceEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseSetCoinbasePriceEvent();
...
export const EventSetPythPrices = {
    ...
    fromJSON(object) {
        return { prices: Array.isArray(object === null || object === void 0 ? void 0 : object.prices) ? object.prices.map((e) => PythPriceState.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.prices) {
    ...
    create(base) {
        return EventSetPythPrices.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseEventSetPythPrices();
        message.prices = ((_a = object.prices) === null || _a === void 0 ? void 0 : _a.map((e) => PythPriceState.fromPartial(e))) || [];
        return message;
    },
};
