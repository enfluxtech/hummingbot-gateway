...
var getTotalPools = /*#__PURE__*/function () {
  var _ref5 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
...
var ftGetTokenMetadata = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            return _context4.abrupt("return", _extends({}, metadata, {
              id: id
            }));
  ...
  return function ftGetTokenMetadata(_x4) {
    return _ref6.apply(this, arguments);
  };
}();
var ftGetTokensMetadata = /*#__PURE__*/function () {
  var _ref7 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(tokenIds) {
    var tokensMetadata;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            tokensMetadata = _context5.sent;
            return _context5.abrupt("return", tokensMetadata.reduce(function (pre, cur, i) {
              var _extends2;
  ...
  return function ftGetTokensMetadata(_x5) {
...
var instantSwap = /*#__PURE__*/function () {
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref) {
    ...
    var tokenIn, tokenOut, amountIn, slippageTolerance, swapTodos, AccountId, transactions, registerToken, actionsList, allSwapsTokens, i, swapTokens, registered;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (!((swapTodos == null ? void 0 : (_swapTodos$at = swapTodos.at(-1)) == null ? void 0 : _swapTodos$at.outputToken) !== tokenOut.id)) {
              _context2.next = 4;
              break;
            }
...
var singlePoolSwap = function singlePoolSwap(_ref3) {
  ...
  } else if (!maxSimplePoolEstimate) return maxStablePoolEstimate;else {
...
export { AccountIdMisMatch, DEFAULT_PAGE_LIMIT, FEE_DIVISOR, InValidAccessKeyError, NoCredential, NoLocalSignerError, NoPoolError, NoPuiblicKeyError, NotLoginError, ONE_YOCTO_NEAR, ONLY_ZEROS, RATED_POOL_LP_TOKEN_DECIMALS, REF_FI_CONTRACT_ID, STABLE_LP_TOKEN_DECIMALS, STORAGE_TO_REGISTER_WITH_MFT, SameInputTokenError, SwapRouteError, TokenNotExistError, ZeroInputError, calc_d, calc_swap, calc_y, config, convertToPercentDecimal, estimateSwap, fetchAllPools, formatError, formatWithCommas, ftGetStorageBalance, ftGetTokenMetadata, ftGetTokensMetadata, ftViewFunction, getAmount, getConfig, getGas, getHybridStableSmart, getKeyStore, getMemorySigner, getPoolEstimate, getPoolsByTokens, getRatedPoolDetail, getRefPools, getSignedTransactionsByMemoryKey, getSimplePoolEstimate, getStablePoolDecimal, getStablePoolEstimate, getStablePools, getStablePoolsThisPair, getSwappedAmount, getTotalPools, getUnRatedPoolDetail, instantSwap, isStablePool, isStablePoolToken, near, parsePool, percentLess, percentOf, poolFormatter, provider, refFiViewFunction, round, scientificNotationToString, sendTransactionsByMemoryKey, singlePoolSwap, toNonDivisibleNumber, toPrecision, toReadableNumber, transformTransactions, unNamedError };
//# sourceMappingURL=coinalpha-ref-sdk.esm.js.map
