...
export const InstantiateContractProposal = {
    ...
    fromPartial(object) {
        ...
        message.funds = ((_h = object.funds) === null || _h === void 0 ? void 0 : _h.map((e) => Coin.fromPartial(e))) || [];
        return message;
    },
};
...
export const InstantiateContract2Proposal = {
    ...
    create(base) {
        return InstantiateContract2Proposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const AccessConfigUpdate = {
    ...
    create(base) {
        return AccessConfigUpdate.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseAccessConfigUpdate();
...
export const UpdateInstantiateConfigProposal = {
    ...
    create(base) {
        return UpdateInstantiateConfigProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseUpdateInstantiateConfigProposal();
        message.title = (_a = object.title) !== null && _a !== void 0 ? _a : "";
        message.description = (_b = object.description) !== null && _b !== void 0 ? _b : "";
        message.accessConfigUpdates = ((_c = object.accessConfigUpdates) === null || _c === void 0 ? void 0 : _c.map((e) => AccessConfigUpdate.fromPartial(e))) || [];
        return message;
    },
};
...
export const StoreAndInstantiateContractProposal = {
    ...
    create(base) {
        return StoreAndInstantiateContractProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.funds = ((_j = object.funds) === null || _j === void 0 ? void 0 : _j.map((e) => Coin.fromPartial(e))) || [];
