...
exports.floatStringWithDecimalToFixed = exports.floatStringWithDecimalToBigNumber = exports.toFractionString = exports.fromFractionString = exports.walletPath = exports.latency = exports.safeJsonParse = exports.tokenValueToString = exports.gasCostInEthString = exports.bigNumberWithDecimalToStr = exports.countDecimals = void 0;
...
const tokenValueToString = (t) => {
    return typeof t === 'string'
        ? t
        : (0, exports.bigNumberWithDecimalToStr)(t.value, t.decimals);
};
...
const floatStringWithDecimalToBigNumber = (floatString, d) => {
    if (d < 0) {
        return null;
    }
    ...
    try {
        return ethers_1.BigNumber.from(left + right);
    }
    catch (_e) {
        return null;
    }
};
exports.floatStringWithDecimalToBigNumber = floatStringWithDecimalToBigNumber;
const floatStringWithDecimalToFixed = (floatString, d) => {
    if (d < 0) {
        return null;
    }
    const split = floatString.split('.');
...
exports.floatStringWithDecimalToFixed = floatStringWithDecimalToFixed;
