...
const xrpl_2 = require("../../../src/connectors/xrpl/xrpl");
const patch_1 = require("../../services/patch");
let xrpl;
let xrplCLOB;
const TX_HASH = 'ADEC6FF35C49B9FF5D06741B5D219D194568919A57876E29296AC530EB25F1CB';
    ...
    asks: [
        {
            ...
            BookDirectory: 'DFA3B6DDAB58C7E8E5D944E736DA4B7046C30E4F460FD9DE4E1282583CD33780',
            BookNode: '0',
            Flags: 0,
            LedgerEntryType: 'Offer',
            OwnerNode: '0',
            PreviousTxnID: '5F8F23607A58A936A5F1D355A7A7491474AABB115C70F5773F3510082EE9B9CB',
        ...
        },
        {
            ...
            BookDirectory: 'DFA3B6DDAB58C7E8E5D944E736DA4B7046C30E4F460FD9DE4E12826062F5399E',
            BookNode: '0',
            Flags: 0,
            LedgerEntryType: 'Offer',
            OwnerNode: '0',
            PreviousTxnID: 'AEA372417F1BEA783D317ADA70ECE577424F186F663AD621C2B26350784611AC',
        ...
        },
        {
            ...
            BookDirectory: 'DFA3B6DDAB58C7E8E5D944E736DA4B7046C30E4F460FD9DE4E12843D2E482F0A',
            BookNode: '0',
            Flags: 131072,
            LedgerEntryType: 'Offer',
            OwnerNode: '1024a',
            PreviousTxnID: '4C9178098581A43C88E8C42760D9CF86CCDC9B18B99DDA20E91CEA63BC156559',
    ...
    bids: [
        {
            ...
            BookDirectory: '4627DFFCFF8B5A265EDBD8AE8C14A52325DBFEDAF4F5C32E5B06E2259ADB6200',
            BookNode: '0',
            Flags: 0,
            LedgerEntryType: 'Offer',
            OwnerNode: '3',
            PreviousTxnID: 'F4D2C5D67C38C30E611815222D1402ECD438DE167252BF434E2CFA58BF69E804',
        ...
        {
            Account: 'rBTwLga3i2gz3doX6Gva3MgEV8ZCD8jjah',
            BookDirectory: '4627DFFCFF8B5A265EDBD8AE8C14A52325DBFEDAF4F5C32E5B06E72B1C323523',
            BookNode: '0',
            Flags: 0,
            LedgerEntryType: 'Offer',
            OwnerNode: '0',
            PreviousTxnID: '79759B2B346BADF16A3E0A7CC52F7EE77AAE356FAB04178F097329CAEBD25FB5',
            PreviousTxnLgrSeq: 80327788,
            Sequence: 95908935,
            TakerGets: {
                currency: 'USD',
        ...
        {
            Account: 'r39rBggWHTUN95x31mAdxPCC7XnhuHRHor',
            BookDirectory: '4627DFFCFF8B5A265EDBD8AE8C14A52325DBFEDAF4F5C32E5B06E72BAB10809A',
            BookNode: '0',
            Flags: 0,
            LedgerEntryType: 'Offer',
            OwnerNode: '1024a',
            PreviousTxnID: 'A5F18BB1F514F879E6B896F2353E84E5AD67D537B494D5C3237B7AA7B93CA9EC',
            PreviousTxnLgrSeq: 80327776,
            Sequence: 3289831,
            TakerGets: {
                currency: 'USD',
    ...
    asks: [
        {
            ...
            BookDirectory: 'DFA3B6DDAB58C7E8E5D944E736DA4B7046C30E4F460FD9DE491CC6E836AE4000',
            BookNode: '0',
            Flags: 131072,
            LedgerEntryType: 'Offer',
            OwnerNode: '0',
            PreviousTxnID: '44A811F5EE120D2215A7F482BDC4C0AF048C82C895C69E7E0FEC6163FCA5A48E',
        ...
        },
        {
            ...
            BookDirectory: 'DFA3B6DDAB58C7E8E5D944E736DA4B7046C30E4F460FD9DE491CDAE1056DB731',
            BookNode: '0',
            Flags: 0,
            LedgerEntryType: 'Offer',
            OwnerNode: '0',
            PreviousTxnID: '5AA8D0E7FAB6E1C854F8E69C3C84A095FC9FEFF3BF29072D2D435758CA52DB9E',
        ...
        },
        {
            ...
            LedgerEntryType: 'Offer',
            OwnerNode: '0',
            PreviousTxnID: 'CF1FDE17372D00219401EB4847B3281A2AF76485BEB0EDF7DF7A6D5DC387C6C6',
...
beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
    xrpl = xrpl_1.XRPL.getInstance('testnet');
    xrplCLOB = xrpl_2.XRPLCLOB.getInstance('xrpl', 'testnet');
    patchConnect();
}));
beforeEach(() => {
    patchConnect();
...
const patchConnect = () => {
    (0, patch_1.patch)(xrpl, 'ensureConnection', () => __awaiter(void 0, void 0, void 0, function* () {
        return Promise.resolve();
    }));
};
const patchFee = () => {
    (0, patch_1.patch)(xrpl, 'getFee', () => {
        return {
            base: '1',
            median: '1',
            minimum: '1',
...
const patchOrderTracking = () => {
    (0, patch_1.patch)(xrplCLOB, 'trackOrder', () => {
        return Promise.resolve();
    });
};
const patchGetOrder = () => {
    (0, patch_1.patch)(xrplCLOB, 'getOrder', () => {
        return undefined;
    });
};
const patchCurrentBlockNumber = (withError = false) => {
    (0, patch_1.patch)(xrplCLOB, 'getCurrentBlockNumber', () => {
        return withError ? -1 : 100;
    });
};
const patchMarkets = () => {
    (0, patch_1.patch)(xrplCLOB, 'parsedMarkets', MARKETS);
};
const patchGetMidPriceForMarket = () => {
    (0, patch_1.patch)(xrplCLOB, 'getMidPriceForMarket', () => {
        return 1.0;
    });
};
const patchGetOrderBookFromXRPL = (orderbook) => {
    (0, patch_1.patch)(xrplCLOB, 'getOrderBookFromXRPL', () => {
        return orderbook;
    });
};
const patchOrders = () => {
    (0, patch_1.patch)(xrplCLOB, '_orderStorage', {
        getOrdersByHash() {
            return __awaiter(this, void 0, void 0, function* () {
                const orders = { [ORDER.hash]: ORDER };
                return orders;
            });
        },
        getOrdersByMarket() {
...
const patchSubmitTxn = () => {
    (0, patch_1.patch)(xrplCLOB, 'submitTxn', () => {
        return {
            prepared: {
                Sequence: 1234567,
            },
...
const patchGetWallet = () => {
    (0, patch_1.patch)(xrplCLOB, 'getWallet', () => {
        return {
...
const patchGasPrices = () => {
    (0, patch_1.patch)(xrplCLOB, 'getFeeEstimate', () => {
        return GAS_PRICES;
    });
};
...
describe('GET /clob/orderBook', () => {
    it('should return 200 with proper request with ORDER_BOOK_1', () => __awaiter(void 0, void 0, void 0, function* () {
        patchMarkets();
        ...
        yield (0, supertest_1.default)(app_1.gatewayApp)
            ...
            .expect((res) => expect(res.body.sells[0].price).toEqual('0.5209865069999999'))
            .expect((res) => expect(res.body.sells[0].quantity).toEqual('60133'));
    }));
    it('should return 200 with proper request with ORDER_BOOK_2', () => __awaiter(void 0, void 0, void 0, function* () {
        patchMarkets();
...
describe('GET /clob/orders', () => {
    it('should return 200 with proper request', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(app_1.gatewayApp)
            ...
            connector: 'xrpl',
            market: MARKET,
            address: 'rh8LssQyeBdEXk7Zv86HxHrx8k2R2DBUrx',
            orderId: '1234567',
        })
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
