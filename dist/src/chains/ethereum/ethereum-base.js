        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.ready()) {
                this._initialized = (() => __awaiter(this, void 0, void 0, function* () {
                    try {
                        yield this._nonceManager.init((address) => __awaiter(this, void 0, void 0, function* () { return yield this.provider.getTransactionCount(address); }));
    ...
    getTokenList(tokenListSource, tokenListType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mappedTokens = tokens.map((token) => {
                token.address = (0, utils_1.getAddress)(token.address);
                return token;
            });
            return mappedTokens;
        });
