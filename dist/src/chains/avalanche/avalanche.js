...
class Avalanche extends ethereum_base_1.EthereumBase {
    constructor(network) {
        ...
        super('avalanche', config.network.chainID, config.network.nodeURL, config.network.tokenListSource, config.network.tokenListType, config.manualGasPrice, config.gasLimitTransaction, config_manager_v2_1.ConfigManagerV2.getInstance().get('server.nonceDbPath'), config_manager_v2_1.ConfigManagerV2.getInstance().get('server.transactionDbPath'));
    ...
    getSpender(reqSpender) {
        ...
        if (reqSpender === 'pangolin') {
            ...
            spender = openocean_config_1.OpenoceanConfig.config.routerAddress('avalanche', this._chain);
        }
            ...
            spender = sushiswap_config_1.SushiswapConfig.config.sushiswapRouterAddress('avalanche', this._chain);
        }
