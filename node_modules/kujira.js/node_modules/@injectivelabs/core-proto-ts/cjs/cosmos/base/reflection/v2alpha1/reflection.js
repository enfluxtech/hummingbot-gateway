...
exports.TxDescriptor = {
    ...
    fromJSON(object) {
        return {
            ...
            msgs: Array.isArray(object === null || object === void 0 ? void 0 : object.msgs) ? object.msgs.map((e) => exports.MsgDescriptor.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.QueryServiceDescriptor = {
    ...
    fromJSON(object) {
        return {
            ...
            methods: Array.isArray(object === null || object === void 0 ? void 0 : object.methods) ? object.methods.map((e) => exports.QueryMethodDescriptor.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
