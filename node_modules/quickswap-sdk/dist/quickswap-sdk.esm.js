...
Currency.ETHER = (_Currency$ETHER = {}, _Currency$ETHER[ChainId.MUMBAI] = /*#__PURE__*/new Currency(18, 'MATIC', 'Matic'), _Currency$ETHER[ChainId.MATIC] = /*#__PURE__*/new Currency(18, 'MATIC', 'Matic'), _Currency$ETHER[ChainId.DOEGCHAIN_TESTNET] = /*#__PURE__*/new Currency(18, 'WDOGE', 'Wrapped Doge'), _Currency$ETHER[ChainId.DOGECHAIN] = /*#__PURE__*/new Currency(18, 'WDOGE', 'Wrapped Doge'), _Currency$ETHER[ChainId.ZKTESTNET] = /*#__PURE__*/new Currency(18, 'ETH', 'Ether'), _Currency$ETHER);
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === ETHER[route.pairs[0].chainId] ? CurrencyAmount.ether(amounts[0].raw, route.pairs[0].chainId) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === ETHER[route.pairs[0].chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, route.pairs[0].chainId) : amounts[amounts.length - 1];
...
//# sourceMappingURL=quickswap-sdk.esm.js.map
