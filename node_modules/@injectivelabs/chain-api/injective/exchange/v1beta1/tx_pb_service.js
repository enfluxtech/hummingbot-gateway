...
Msg.TransferAndExecute = {
  methodName: "TransferAndExecute",
  service: Msg,
  requestStream: false,
  responseStream: false,
  requestType: injective_exchange_v1beta1_tx_pb.MsgTransferAndExecute,
  responseType: injective_exchange_v1beta1_tx_pb.MsgTransferAndExecuteResponse
};

Msg.MultiExecute = {
  methodName: "MultiExecute",
  service: Msg,
  requestStream: false,
  responseStream: false,
  requestType: injective_exchange_v1beta1_tx_pb.MsgMultiExecute,
  responseType: injective_exchange_v1beta1_tx_pb.MsgMultiExecuteResponse
};
...
Msg.InstantBinaryOptionsMarketLaunch = {
...
Msg.CreateBinaryOptionsMarketOrder = {
...
Msg.BatchCancelBinaryOptionsOrders = {
...
Msg.AdminUpdateBinaryOptionsMarket = {
...
MsgClient.prototype.transferAndExecute = function transferAndExecute(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.TransferAndExecute, {
...
MsgClient.prototype.multiExecute = function multiExecute(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.MultiExecute, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.batchUpdateOrders = function batchUpdateOrders(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.BatchUpdateOrders, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.privilegedExecuteContract = function privilegedExecuteContract(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.PrivilegedExecuteContract, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.instantBinaryOptionsMarketLaunch = function instantBinaryOptionsMarketLaunch(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.InstantBinaryOptionsMarketLaunch, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.createBinaryOptionsLimitOrder = function createBinaryOptionsLimitOrder(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.CreateBinaryOptionsLimitOrder, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.createBinaryOptionsMarketOrder = function createBinaryOptionsMarketOrder(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.CreateBinaryOptionsMarketOrder, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.cancelBinaryOptionsOrder = function cancelBinaryOptionsOrder(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.CancelBinaryOptionsOrder, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.batchCancelBinaryOptionsOrders = function batchCancelBinaryOptionsOrders(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.BatchCancelBinaryOptionsOrders, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.rewardsOptOut = function rewardsOptOut(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.RewardsOptOut, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.adminUpdateBinaryOptionsMarket = function adminUpdateBinaryOptionsMarket(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.AdminUpdateBinaryOptionsMarket, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
MsgClient.prototype.reclaimLockedFunds = function reclaimLockedFunds(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.ReclaimLockedFunds, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
