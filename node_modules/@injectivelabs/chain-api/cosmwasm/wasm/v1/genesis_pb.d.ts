...
export class GenesisState extends jspb.Message {
  ...
  setGenMsgsList(value: Array<GenesisState.GenMsgs>): void;
...
export namespace GenesisState {
  ...
  export class GenMsgs extends jspb.Message {
    ...
    setStoreCode(value?: cosmwasm_wasm_v1_tx_pb.MsgStoreCode): void;
    ...
    setInstantiateContract(value?: cosmwasm_wasm_v1_tx_pb.MsgInstantiateContract): void;
    ...
    setExecuteContract(value?: cosmwasm_wasm_v1_tx_pb.MsgExecuteContract): void;
...
export class Code extends jspb.Message {
  ...
  setCodeInfo(value?: cosmwasm_wasm_v1_types_pb.CodeInfo): void;
...
export class Contract extends jspb.Message {
  ...
  setContractStateList(value: Array<cosmwasm_wasm_v1_types_pb.Model>): void;
...
export class Sequence extends jspb.Message {
  ...
  setIdKey(value: Uint8Array | string): void;
