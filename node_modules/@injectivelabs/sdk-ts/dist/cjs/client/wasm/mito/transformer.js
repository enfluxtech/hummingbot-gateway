...
exports.MitoQueryTransformer = void 0;
...
class MitoQueryTransformer {
    ...
    static vaultContractMarketMakingResponseToMarketMaking(config) {
        return {
            ...
            minTradeVolatilitySampleSize: Number(config.min_trade_volatility_sample_size),
    ...
    static vaultContractConfigResponseToAMMVaultConfig(response) {
        const { config } = JSON.parse((0, utils_1.toUtf8)(response.data));
        return {
...
exports.MitoQueryTransformer = MitoQueryTransformer;
