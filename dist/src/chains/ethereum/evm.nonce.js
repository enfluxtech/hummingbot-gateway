...
class EVMNonceManager extends refcounting_closeable_1.ReferenceCountingCloseable {
    ...
    mergeNonceFromEVMNode(ethAddress, intializationPhase = false) {
        return __awaiter(this, void 0, void 0, function* () {
            if (intializationPhase || __classPrivateFieldGet(this, _EVMNonceManager_initialized, "f")) {
                ...
                const externalNonce = (yield this._getTransactionCount(ethAddress)) - 1;
    ...
    overridePendingNonce(ethAddress, newNonceValue) {
        return __awaiter(this, void 0, void 0, function* () {
            const now = new Date().getTime();
