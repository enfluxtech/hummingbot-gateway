...
export const TextProposal = {
    ...
    create(base) {
        return TextProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseTextProposal();
...
export const Proposal = {
    ...
    fromPartial(object) {
        ...
        message.totalDeposit = ((_e = object.totalDeposit) === null || _e === void 0 ? void 0 : _e.map((e) => Coin.fromPartial(e))) || [];
...
export const Vote = {
    ...
    fromPartial(object) {
        ...
        message.options = ((_d = object.options) === null || _d === void 0 ? void 0 : _d.map((e) => WeightedVoteOption.fromPartial(e))) || [];
        return message;
    },
};
