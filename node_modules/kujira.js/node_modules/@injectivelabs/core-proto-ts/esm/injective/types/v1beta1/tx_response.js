...
export const TxResponseGenericMessage = {
    ...
    create(base) {
        return TxResponseGenericMessage.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseTxResponseGenericMessage();
...
export const TxResponseData = {
    ...
    fromJSON(object) {
        return {
            messages: Array.isArray(object === null || object === void 0 ? void 0 : object.messages)
                ? object.messages.map((e) => TxResponseGenericMessage.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
    ...
    create(base) {
        return TxResponseData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseTxResponseData();
        message.messages = ((_a = object.messages) === null || _a === void 0 ? void 0 : _a.map((e) => TxResponseGenericMessage.fromPartial(e))) || [];
        return message;
    },
};
