...
exports.ContractExecutionAuthorization = {
    ...
    fromJSON(object) {
        return { grants: Array.isArray(object === null || object === void 0 ? void 0 : object.grants) ? object.grants.map((e) => exports.ContractGrant.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.grants) {
...
exports.MaxFundsLimit = {
    ...
    fromJSON(object) {
        return { amounts: Array.isArray(object === null || object === void 0 ? void 0 : object.amounts) ? object.amounts.map((e) => coin_1.Coin.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.amounts) {
...
exports.CombinedLimit = {
    ...
    fromJSON(object) {
        return {
            ...
            amounts: Array.isArray(object === null || object === void 0 ? void 0 : object.amounts) ? object.amounts.map((e) => coin_1.Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
