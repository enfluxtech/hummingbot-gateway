...
class UniswapLPHelper {
    ...
    poolPrice(token0, token1, tier, period = 1, interval = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const prices = [];
            const fee = uniV3.FeeAmount[tier];
            const poolContract = new contracts_1.Contract(uniV3.Pool.getAddress(token0, token1, fee), this.poolAbi, this.ethereum.provider);
    ...
    addPositionHelper(wallet, token0, token1, amount0, amount1, fee, lowerPrice, upperPrice, tokenId = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const methodParameters = uniV3.NonfungiblePositionManager.addCallParameters(position, Object.assign(Object.assign({}, swapOptions), addLiquidityOptions));
