...
const tinyman_controllers_1 = require("../connectors/tinyman/tinyman.controllers");
const perp_controllers_1 = require("../connectors/perp/perp.controllers");
const plenty_controllers_1 = require("../connectors/plenty/plenty.controllers");
...
function price(req) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (connector instanceof plenty_1.Plenty) {
            return (0, plenty_controllers_1.price)(chain, connector, req);
        }
        else if ('routerAbi' in connector) {
            return (0, uniswap_controllers_1.price)(chain, connector, req);
        }
        else if (connector instanceof tinyman_1.Tinyman) {
            return (0, tinyman_controllers_1.price)(chain, connector, req);
        }
        else {
...
function trade(req) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const connector = yield (0, connection_manager_1.getConnector)(req.chain, req.network, req.connector);
        if (connector instanceof plenty_1.Plenty) {
            return (0, plenty_controllers_1.trade)(chain, connector, req);
        }
        else if ('routerAbi' in connector) {
            return (0, uniswap_controllers_1.trade)(chain, connector, req);
        }
        else if (connector instanceof tinyman_1.Tinyman) {
            return (0, tinyman_controllers_1.trade)(chain, connector, req);
        }
        else {
...
function estimateGas(req) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const connector = yield (0, connection_manager_1.getConnector)(req.chain, req.network, req.connector);
        if (connector instanceof plenty_1.Plenty) {
            return (0, plenty_controllers_1.estimateGas)(chain, connector);
        }
        else if ('routerAbi' in connector) {
            return (0, uniswap_controllers_1.estimateGas)(chain, connector);
        }
        else if (connector instanceof tinyman_1.Tinyman) {
            return (0, tinyman_controllers_1.estimateGas)(chain, connector);
        }
        else {
