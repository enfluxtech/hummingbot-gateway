...
exports.SetBatchConfigProposal = {
    ...
    toJSON(message) {
        ...
        if (message.feedProperties) {
            obj.feedProperties = message.feedProperties.map((e) => e ? exports.FeedProperties.toJSON(e) : undefined);
        }
        else {
            obj.feedProperties = [];
        }
...
exports.GasReimbursements = {
    ...
    toJSON(message) {
        ...
        if (message.reimbursements) {
            obj.reimbursements = message.reimbursements.map((e) => e ? coin_1.Coin.toJSON(e) : undefined);
        }
        else {
            obj.reimbursements = [];
        }
