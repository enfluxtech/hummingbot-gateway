...
beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield bsc.init();
    pancakeswap = pancakeswap_lp_1.PancakeswapLP.getInstance('binance-smart-chain', 'testnet');
...
const patchInit = () => {
    (0, patch_1.patch)(pancakeswap, 'init', () => __awaiter(void 0, void 0, void 0, function* () {
        return;
    }));
};
...
const patchAddPosition = () => {
    (0, patch_1.patch)(pancakeswap, 'addPosition', () => {
        return { nonce: 21, hash: '000000000000000' };
    });
};
const patchRemovePosition = () => {
    (0, patch_1.patch)(pancakeswap, 'reducePosition', () => {
        return { nonce: 21, hash: '000000000000000' };
    });
};
const patchCollectFees = () => {
    (0, patch_1.patch)(pancakeswap, 'collectFees', () => {
        return { nonce: 21, hash: '000000000000000' };
    });
};
const patchPosition = () => {
    (0, patch_1.patch)(pancakeswap, 'getPosition', () => {
        return {
            token0: 'DAI',
            token1: 'WETH',
            fee: 300,
...
describe('POST /liquidity/add', () => {
    ...
    it('should return 500 when the helper operation fails', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patchGetTokenBySymbol();
        patchGetTokenByAddress();
        (0, patch_1.patch)(pancakeswap, 'addPositionHelper', () => {
            return 'error';
        });
        yield (0, supertest_1.default)(app)
            .post(`/amm/liquidity/add`)
...
describe('POST /liquidity/price', () => {
    const patchForBuy = () => {
        ...
        patchGetTokenBySymbol();
        patchGetTokenByAddress();
        (0, patch_1.patch)(pancakeswap, 'poolPrice', () => {
            return ['100', '105'];
        });
    };
    it('should return 200 when all parameter are OK', () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=pancakeswap.lp.routes.test.js.map