...
(function (ChainId) {
  ...
  ChainId[ChainId["ZKTESTNET"] = 1402] = "ZKTESTNET";
...
var FACTORY_ADDRESS = '0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32'; //TODO Need to change this. This address should be same for both testnet and mainnet
...
Currency.ETHER = (_Currency$ETHER = {}, _Currency$ETHER[exports.ChainId.MUMBAI] = /*#__PURE__*/new Currency(18, 'MATIC', 'Matic'), _Currency$ETHER[exports.ChainId.MATIC] = /*#__PURE__*/new Currency(18, 'MATIC', 'Matic'), _Currency$ETHER[exports.ChainId.DOEGCHAIN_TESTNET] = /*#__PURE__*/new Currency(18, 'WDOGE', 'Wrapped Doge'), _Currency$ETHER[exports.ChainId.DOGECHAIN] = /*#__PURE__*/new Currency(18, 'WDOGE', 'Wrapped Doge'), _Currency$ETHER[exports.ChainId.ZKTESTNET] = /*#__PURE__*/new Currency(18, 'ETH', 'Ether'), _Currency$ETHER);
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MUMBAI] = /*#__PURE__*/new Token(exports.ChainId.MUMBAI, '0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889', 18, 'WMATIC', 'Wrapped Matic'), _WETH[exports.ChainId.MATIC] = /*#__PURE__*/new Token(exports.ChainId.MATIC, '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', 18, 'WMATIC', 'Wrapped Matic'), _WETH[exports.ChainId.DOEGCHAIN_TESTNET] = /*#__PURE__*/new Token(exports.ChainId.DOEGCHAIN_TESTNET, '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', 18, 'WDOGE', 'Wrapped Doge'), _WETH[exports.ChainId.DOGECHAIN] = /*#__PURE__*/new Token(exports.ChainId.DOGECHAIN, '0xB7ddC6414bf4F5515b52D8BdD69973Ae205ff101', 18, 'WDOGE', 'Wrapped Doge'), _WETH[exports.ChainId.ZKTESTNET] = /*#__PURE__*/new Token(exports.ChainId.ZKTESTNET, '0xE9CC37904875B459Fa5D0FE37680d36F1ED55e38', 18, 'WETH', 'Wrapped Ether'), _WETH);
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === ETHER[route.pairs[0].chainId] ? CurrencyAmount.ether(amounts[0].raw, route.pairs[0].chainId) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === ETHER[route.pairs[0].chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, route.pairs[0].chainId) : amounts[amounts.length - 1];
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === exports.TradeType.EXACT_OUTPUT) {
      ...
      return this.outputAmount instanceof TokenAmount ? new TokenAmount(this.outputAmount.token, slippageAdjustedAmountOut) : CurrencyAmount.ether(slippageAdjustedAmountOut, this.route.pairs[0].chainId);
    }
  }
  /**
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === exports.TradeType.EXACT_INPUT) {
      ...
      return this.inputAmount instanceof TokenAmount ? new TokenAmount(this.inputAmount.token, slippageAdjustedAmountIn) : CurrencyAmount.ether(slippageAdjustedAmountIn, this.route.pairs[0].chainId);
    }
  }
  /**
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency === ETHER[trade.route.pairs[0].chainId];
    var etherOut = trade.outputAmount.currency === ETHER[trade.route.pairs[0].chainId]; // the router does not support both ether in and out
...
//# sourceMappingURL=quickswap-sdk.cjs.development.js.map
