...
export class GenesisState extends jspb.Message {
  ...
  clearChainlinkPriceStatesList(): void;
  getChainlinkPriceStatesList(): Array<injective_oracle_v1beta1_oracle_pb.ChainlinkPriceState>;
  setChainlinkPriceStatesList(value: Array<injective_oracle_v1beta1_oracle_pb.ChainlinkPriceState>): void;
  addChainlinkPriceStates(value?: injective_oracle_v1beta1_oracle_pb.ChainlinkPriceState, index?: number): injective_oracle_v1beta1_oracle_pb.ChainlinkPriceState;

  clearHistoricalPriceRecordsList(): void;
  getHistoricalPriceRecordsList(): Array<injective_oracle_v1beta1_oracle_pb.PriceRecords>;
  setHistoricalPriceRecordsList(value: Array<injective_oracle_v1beta1_oracle_pb.PriceRecords>): void;
  addHistoricalPriceRecords(value?: injective_oracle_v1beta1_oracle_pb.PriceRecords, index?: number): injective_oracle_v1beta1_oracle_pb.PriceRecords;

  clearProviderStatesList(): void;
  getProviderStatesList(): Array<injective_oracle_v1beta1_oracle_pb.ProviderState>;
  setProviderStatesList(value: Array<injective_oracle_v1beta1_oracle_pb.ProviderState>): void;
  addProviderStates(value?: injective_oracle_v1beta1_oracle_pb.ProviderState, index?: number): injective_oracle_v1beta1_oracle_pb.ProviderState;
...
export namespace GenesisState {
  export type AsObject = {
    ...
    chainlinkPriceStatesList: Array<injective_oracle_v1beta1_oracle_pb.ChainlinkPriceState.AsObject>,
    historicalPriceRecordsList: Array<injective_oracle_v1beta1_oracle_pb.PriceRecords.AsObject>,
    providerStatesList: Array<injective_oracle_v1beta1_oracle_pb.ProviderState.AsObject>,
  }
}
