...
var proofs_pb = require('../../../../proofs_pb.js');
goog.object.extend(proto, proofs_pb);
...
proto.ibc.core.commitment.v1.MerkleProof.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proofs_pb.CommitmentProof.toObject, includeInstance)
  };
...
proto.ibc.core.commitment.v1.MerkleProof.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proofs_pb.CommitmentProof;
      reader.readMessage(value,proofs_pb.CommitmentProof.deserializeBinaryFromReader);
      msg.addProofs(value);
      break;
    default:
      reader.skipField();
...
proto.ibc.core.commitment.v1.MerkleProof.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proofs_pb.CommitmentProof.serializeBinaryToWriter
    );
  }
};
...
proto.ibc.core.commitment.v1.MerkleProof.prototype.getProofsList = function() {
  return /** @type{!Array<!proto.ics23.CommitmentProof>} */ (
    jspb.Message.getRepeatedWrapperField(this, proofs_pb.CommitmentProof, 1));
};
