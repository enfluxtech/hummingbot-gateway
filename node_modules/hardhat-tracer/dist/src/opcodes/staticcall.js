...
exports.printStaticCall = void 0;
...
async function printStaticCall(structLog, index, structLogs, dependencies) {
    ...
    // input data
    const input = (0, utils_1.hexlify)((0, utils_2.parseMemory)(structLog.memory).slice(argsOffset, argsOffset + argsSize));
    // return data
