...
export const QueryInterchainAccountRequest = {
    ...
    create(base) {
        return QueryInterchainAccountRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseQueryInterchainAccountRequest();
...
export const QueryInterchainAccountResponse = {
    ...
    create(base) {
        return QueryInterchainAccountResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryInterchainAccountResponse();
