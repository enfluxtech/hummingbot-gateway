...
const evm_nonce_1 = require("../ethereum/evm.nonce");
const node_cache_1 = __importDefault(require("node-cache"));
const evm_tx_storage_1 = require("../ethereum/evm.tx-storage");
...
class XdcBase {
    constructor(chainName, chainId, rpcUrl, tokenListSource, tokenListType, gasPriceConstant, gasLimitTransaction, nonceDbPath, transactionDbPath) {
        ...
        this._provider = new ethers_xdc_1.providers.StaticJsonRpcProvider(rpcUrl);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.ready()) {
                this._initialized = (() => __awaiter(this, void 0, void 0, function* () {
                    try {
                        yield this._nonceManager.init((address) => __awaiter(this, void 0, void 0, function* () { return (yield this.provider.getTransactionCount(address)) - 1; }));
    ...
    getWalletFromPrivateKey(privateKey) {
        return new ethers_xdc_1.Wallet(privateKey, this._provider);
    }
    getWallet(address) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    decrypt(encryptedPrivateKey, password) {
        return __awaiter(this, void 0, void 0, function* () {
            const wallet = yield ethers_xdc_1.Wallet.fromEncryptedJson(encryptedPrivateKey, password);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return this.nonceManager.provideNonce(nonce, wallet.address, (nextNonce) => __awaiter(this, void 0, void 0, function* () {
                const tx = {
                    from: wallet.address,
                    to: wallet.address,
                    value: ethers_xdc_1.utils.parseEther('0'),
                    nonce: nextNonce,
...
exports.XdcBase = XdcBase;
//# sourceMappingURL=xdc.base.js.map