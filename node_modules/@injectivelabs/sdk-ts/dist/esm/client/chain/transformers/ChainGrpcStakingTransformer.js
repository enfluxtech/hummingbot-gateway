...
export class ChainGrpcStakingTransformer {
    ...
    static delegationsResponseToDelegations(response) {
        ...
        const delegations = grpcDelegations
            ...
            .filter((delegation) => new BigNumberInWei(delegation.balance.amount).toBase().gte(DUST_AMOUNT));
        return {
            delegations,
            pagination: grpcPaginationToPagination(response.pagination),
        };
    ...
    static unBondingDelegationsResponseToUnBondingDelegations(response) {
        ...
        const unbondingDelegations = grpcUnbondingDelegations
            ...
            .filter((delegation) => new BigNumberInWei(delegation.balance).toBase().gte(DUST_AMOUNT));
        return {
