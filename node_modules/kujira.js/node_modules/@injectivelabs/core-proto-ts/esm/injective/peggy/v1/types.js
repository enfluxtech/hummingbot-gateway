...
export const BridgeValidator = {
    ...
    create(base) {
        return BridgeValidator.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseBridgeValidator();
...
export const Valset = {
    ...
    create(base) {
        return Valset.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d, _e;
        const message = createBaseValset();
        message.nonce = (_a = object.nonce) !== null && _a !== void 0 ? _a : "0";
        message.members = ((_b = object.members) === null || _b === void 0 ? void 0 : _b.map((e) => BridgeValidator.fromPartial(e))) || [];
...
export const LastObservedEthereumBlockHeight = {
    ...
    create(base) {
        return LastObservedEthereumBlockHeight.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseLastObservedEthereumBlockHeight();
...
export const LastClaimEvent = {
    ...
    create(base) {
        return LastClaimEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseLastClaimEvent();
...
export const ERC20ToDenom = {
    ...
    create(base) {
        return ERC20ToDenom.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseERC20ToDenom();
