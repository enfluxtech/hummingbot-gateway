...
export const Validator = {
    ...
    fromJSON(object) {
        return {
            ...
            unbondingIds: Array.isArray(object === null || object === void 0 ? void 0 : object.unbondingIds) ? object.unbondingIds.map((e) => String(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
export const ValidatorUpdates = {
    ...
    create(base) {
        return ValidatorUpdates.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseValidatorUpdates();
        message.updates = ((_a = object.updates) === null || _a === void 0 ? void 0 : _a.map((e) => ValidatorUpdate.fromPartial(e))) || [];
        return message;
    },
};
