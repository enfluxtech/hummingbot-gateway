...
export const BlacklistEthereumAddressesProposal = {
    ...
    create(base) {
        return BlacklistEthereumAddressesProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseBlacklistEthereumAddressesProposal();
...
export const RevokeEthereumBlacklistProposal = {
    ...
    create(base) {
        return RevokeEthereumBlacklistProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseRevokeEthereumBlacklistProposal();
