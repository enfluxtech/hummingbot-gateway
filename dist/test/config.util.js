...
class OverrideConfigs {
    constructor() {
        ...
        this.nonceDbPath = config_manager_v2_1.ConfigManagerV2.getInstance().get('server.nonceDbPath');
        this.transactionDbPath = config_manager_v2_1.ConfigManagerV2.getInstance().get('server.transactionDbPath');
    }
    init() {
    ...
    updateConfigs() {
        config_manager_v2_1.ConfigManagerV2.getInstance().set('server.nonceDbPath', __classPrivateFieldGet(this, _OverrideConfigs_testNonceDbPath, "f"));
        config_manager_v2_1.ConfigManagerV2.getInstance().set('server.transactionDbPath', __classPrivateFieldGet(this, _OverrideConfigs_testTransactionDbPath, "f"));
    }
    resetConfigs() {
        config_manager_v2_1.ConfigManagerV2.getInstance().set('server.nonceDbPath', this.nonceDbPath);
        config_manager_v2_1.ConfigManagerV2.getInstance().set('server.transactionDbPath', this.transactionDbPath);
    }
}
