...
(function (UniswapConfig) {
    UniswapConfig.config = {
        ...
        useRouter: config_manager_v2_1.ConfigManagerV2.getInstance().get(`uniswap.useRouter`),
        feeTier: config_manager_v2_1.ConfigManagerV2.getInstance().get(`uniswap.feeTier`),
        quoterContractAddress: (network) => config_manager_v2_1.ConfigManagerV2.getInstance().get(`uniswap.contractAddresses.${network}.uniswapV3QuoterV2ContractAddress`),
    };
})(UniswapConfig || (exports.UniswapConfig = UniswapConfig = {}));
