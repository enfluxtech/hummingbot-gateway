...
exports.PancakeswapLP = void 0;
const logger_1 = require("../../services/logger");
const pancakeswap_config_1 = require("./pancakeswap.config");
const v3 = __importStar(require("@pancakeswap/v3-sdk"));
const ethers_1 = require("ethers");
const pancakeswap_lp_helper_1 = require("./pancakeswap.lp.helper");
const MaxUint128 = ethers_1.BigNumber.from(2).pow(128).sub(1);
class PancakeswapLP extends pancakeswap_lp_helper_1.PancakeswapLPHelper {
    constructor(chain, network) {
        super(chain, network);
        this._gasLimitEstimate = pancakeswap_config_1.PancakeSwapConfig.config.gasLimitEstimate;
    }
    static getInstance(chain, network) {
        ...
        if (!(chain + network in PancakeswapLP._instances)) {
            PancakeswapLP._instances[chain + network] = new PancakeswapLP(chain, network);
        }
    ...
    getPosition(tokenId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requests = [
                ...
                this.collectFees(this.chain.provider, tokenId),
            ];
    ...
    addPosition(wallet, token0, token1, amount0, amount1, fee, lowerPrice, upperPrice, tokenId = 0, gasLimit, gasPrice, nonce, maxFeePerGas, maxPriorityFeePerGas) {
        return __awaiter(this, void 0, void 0, function* () {
            const convertedFee = v3.FeeAmount[fee];
            const addLiquidityResponse = yield this.addPositionHelper(wallet, token0, token1, amount0, amount1, convertedFee, lowerPrice, upperPrice, tokenId);
            if (nonce === undefined) {
                nonce = yield this.chain.nonceManager.getNextNonce(wallet.address);
            }
            ...
            logger_1.logger.info(`Pancakeswap V3 Add position Tx Hash: ${tx.hash}`);
            return tx;
        });
    }
    reducePosition(wallet, tokenId, decreasePercent = 100, gasLimit, gasPrice, nonce, maxFeePerGas, maxPriorityFeePerGas) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger_1.logger.info(`Pancakeswap V3 Remove position Tx Hash: ${tx.hash}`);
            return tx;
        });
    }
...
exports.PancakeswapLP = PancakeswapLP;
//# sourceMappingURL=pancakeswap.lp.js.map