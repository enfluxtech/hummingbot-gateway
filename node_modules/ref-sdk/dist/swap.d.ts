...
export declare const getStablePoolEstimate: ({ tokenIn, tokenOut, amountIn, stablePool, }: {
    tokenIn: TokenMetadata;
    tokenOut: TokenMetadata;
    amountIn: string;
...
export declare function getHybridStableSmart(tokenIn: TokenMetadata, tokenOut: TokenMetadata, amountIn: string, stablePools: Pool[], stablePoolsDetail: StablePool[], simplePools: Pool[]): Promise<{
    actions: ({
        pool: {
