...
const patchEstimateBuyTrade = () => {
    (0, patch_1.patch)(uniswap, 'estimateBuyTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchEstimateSellTrade = () => {
    (0, patch_1.patch)(uniswap, 'estimateSellTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchExecuteTrade = () => {
    (0, patch_1.patch)(uniswap, 'executeTrade', () => {
...
describe('POST /amm/price', () => {
    ...
    it('should return 500 when the priceSwapIn operation fails', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patchGetTokenBySymbol();
        patchGetTokenByAddress();
        (0, patch_1.patch)(uniswap, 'priceSwapIn', () => {
            return 'error';
        });
        yield (0, supertest_1.default)(app)
            .post(`/amm/price`)
    ...
    it('should return 500 when the priceSwapOut operation fails', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patchGetTokenBySymbol();
        patchGetTokenByAddress();
        (0, patch_1.patch)(uniswap, 'priceSwapOut', () => {
            return 'error';
        });
        yield (0, supertest_1.default)(app)
            .post(`/amm/price`)
...
describe('POST /amm/estimateGas', () => {
    it('should return 200 for valid connector', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(app)
            ...
            expect(res.body.gasCost).toEqual((0, base_1.gasCostInEthString)(100, uniswap.gasLimitEstimate));
        });
    }));
...
//# sourceMappingURL=uniswap.routes.test.js.map