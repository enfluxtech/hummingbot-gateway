...
(function (WalletRoutes) {
    ...
    WalletRoutes.router.get('/sign', (0, error_handler_1.asyncHandler)((req, res) => __awaiter(this, void 0, void 0, function* () {
        (0, wallet_validators_1.validateWalletSignRequest)(req.query);
        res
            .status(200)
            .json(yield (0, wallet_controllers_1.signMessage)(req.query));
    })));
})(WalletRoutes || (exports.WalletRoutes = WalletRoutes = {}));
