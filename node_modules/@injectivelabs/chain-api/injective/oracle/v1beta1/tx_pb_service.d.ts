...
type MsgRelayProviderPrices = {
  ...
  readonly requestType: typeof injective_oracle_v1beta1_tx_pb.MsgRelayProviderPrices;
  readonly responseType: typeof injective_oracle_v1beta1_tx_pb.MsgRelayProviderPricesResponse;
};
...
export class Msg {
  ...
  static readonly RelayProviderPrices: MsgRelayProviderPrices;
...
export class MsgClient {
  ...
  relayProviderPrices(
    requestMessage: injective_oracle_v1beta1_tx_pb.MsgRelayProviderPrices,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: injective_oracle_v1beta1_tx_pb.MsgRelayProviderPricesResponse|null) => void
  ): UnaryResponse;
  relayProviderPrices(
    requestMessage: injective_oracle_v1beta1_tx_pb.MsgRelayProviderPrices,
    callback: (error: ServiceError|null, responseMessage: injective_oracle_v1beta1_tx_pb.MsgRelayProviderPricesResponse|null) => void
