...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return {
            ...
            genMsgs: Array.isArray(object === null || object === void 0 ? void 0 : object.genMsgs) ? object.genMsgs.map((e) => exports.GenesisState_GenMsgs.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            ...
            instantiateContract: isSet(object.instantiateContract)
                ...
                : undefined,
            executeContract: isSet(object.executeContract) ? tx_1.MsgExecuteContract.fromJSON(object.executeContract) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.executeContract !== undefined &&
            (obj.executeContract = message.executeContract ? tx_1.MsgExecuteContract.toJSON(message.executeContract) : undefined);
        return obj;
    },
    create(base) {
        return exports.GenesisState_GenMsgs.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseGenesisState_GenMsgs();
