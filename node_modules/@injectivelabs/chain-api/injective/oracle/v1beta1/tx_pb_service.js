...
MsgClient.prototype.relayProviderPrices = function relayProviderPrices(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.RelayProviderPrices, {
