...
let uniswapLP;
let wallet;
const WETH = new sdk_core_1.Token(5, '0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', 18, 'WETH');
const DAI = new sdk_core_1.Token(5, '0xdc31Ee1784292379Fbb2964b3B9C4124D8F89C60', 18, 'DAI');
const USDC = new sdk_core_1.Token(5, '0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C', 6, 'USDC');
const TX = {
    type: 2,
    chainId: 42,
    nonce: 115,
...
beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    uniswapLP = uniswap_lp_1.UniswapLP.getInstance('ethereum', 'goerli');
...
describe('verify UniswapLP Nft functions', () => {
    ...
    it('addPosition should work', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patchWallet();
        patchAlphaRouter();
        const addTx = yield uniswapLP.addPosition(wallet, DAI, WETH, '10', '10', 'LOWEST', 1, 10, 0, 1, 1);
