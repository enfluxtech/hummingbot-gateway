...
export class MsgRelayProviderPrices extends jspb.Message {
  getSender(): string;
  ...
  toObject(includeInstance?: boolean): MsgRelayProviderPrices.AsObject;
  static toObject(includeInstance: boolean, msg: MsgRelayProviderPrices): MsgRelayProviderPrices.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: MsgRelayProviderPrices, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MsgRelayProviderPrices;
  static deserializeBinaryFromReader(message: MsgRelayProviderPrices, reader: jspb.BinaryReader): MsgRelayProviderPrices;
}

export namespace MsgRelayProviderPrices {
...
export class MsgRelayProviderPricesResponse extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MsgRelayProviderPricesResponse.AsObject;
  static toObject(includeInstance: boolean, msg: MsgRelayProviderPricesResponse): MsgRelayProviderPricesResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: MsgRelayProviderPricesResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MsgRelayProviderPricesResponse;
  static deserializeBinaryFromReader(message: MsgRelayProviderPricesResponse, reader: jspb.BinaryReader): MsgRelayProviderPricesResponse;
}

export namespace MsgRelayProviderPricesResponse {
  export type AsObject = {
  }
}
