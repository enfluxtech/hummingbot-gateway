(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('near-api-js'), require('bn.js'), require('mathjs'), require('big.js'), require('lodash-es')) :
  typeof define === 'function' && define.amd ? define(['exports', 'near-api-js', 'bn.js', 'mathjs', 'big.js', 'lodash-es'], factory) :
  (global = global || self, factory(global['ref-sdk'] = {}, global.nearApiJs, global.BN, global.math, global.Big, global._));
}(this, (function (exports, nearApiJs, BN, math, Big, _) { 'use strict';
  ...
  var keyStore = /*#__PURE__*/new nearApiJs.keyStores.BrowserLocalStorageKeyStore();
  var near = /*#__PURE__*/new nearApiJs.Near( /*#__PURE__*/_extends({
    keyStore: keyStore,
    headers: {}
  }, config));
  var wallet = /*#__PURE__*/new nearApiJs.WalletConnection(near, REF_FI_CONTRACT_ID);
  ...
  var getMemorySigner = function getMemorySigner(_ref) {
    ...
    var myKeyStore = new nearApiJs.keyStores.UnencryptedFileSystemKeyStore(credentialsPath); // myKeyStore.setKey(
    //   getConfig().networkId,
    //   AccountId,
    //   KeyPair.fromString(credentials.private_key)
    // );

    var signer = new nearApiJs.InMemorySigner(myKeyStore);
  ...
  exports.fetchAllRefPools = fetchAllRefPools;
  ...
  exports.getStablePoolsDetail = getStablePoolsDetail;
