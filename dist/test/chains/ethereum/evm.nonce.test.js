...
const evm_nonce_1 = require("../../../src/chains/ethereum/evm.nonce");
...
describe('uninitiated EVMNodeService', () => {
    ...
    it('localNonceTTL value too low', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield expect(nonceManager2.init((address) => __awaiter(void 0, void 0, void 0, function* () { return (yield provider.getTransactionCount(address)) - 1; }))).rejects.toThrow(new error_handler_1.InitializationError((0, error_handler_1.SERVICE_UNITIALIZED_ERROR_MESSAGE)('EVMNonceManager.init localNonceTTL must be greater than or equal to zero.'), error_handler_1.SERVICE_UNITIALIZED_ERROR_CODE));
        }
        finally {
    ...
    it('pendingNonceTTL value too low', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        nonceManager2.declareOwnership(handle);
        try {
            yield expect(nonceManager2.init((address) => __awaiter(void 0, void 0, void 0, function* () { return (yield provider.getTransactionCount(address)) - 1; }))).rejects.toThrow(new error_handler_1.InitializationError((0, error_handler_1.SERVICE_UNITIALIZED_ERROR_MESSAGE)('EVMNonceManager.init pendingNonceTTL must be greater than or equal to zero.'), error_handler_1.SERVICE_UNITIALIZED_ERROR_CODE));
        }
        finally {
            yield nonceManager2.close(handle);
        }
...
describe('EVMNodeService', () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        nonceManager = new evm_nonce_1.EVMNonceManager('ethereum', 43, dbPath, 0, 0);
        nonceManager.declareOwnership(handle);
        yield nonceManager.init((address) => __awaiter(void 0, void 0, void 0, function* () { return (yield provider.getTransactionCount(address)) - 1; }));
    ...
    const patchGetTransactionCount = () => {
        (0, patch_1.patch)(nonceManager, '_getTransactionCount', () => 10);
    };
    ...
    it('commitNonce with a provided txNonce will only update current nonce if txNonce > currentNonce', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(nonce).toEqual(9);
        yield expect(nonceManager.commitNonce(exampleAddress, 5)).rejects.toThrow(new error_handler_1.InvalidNonceError(error_handler_1.INVALID_NONCE_ERROR_MESSAGE + `txNonce(5) < currentNonce(9)`, error_handler_1.INVALID_NONCE_ERROR_CODE));
    ...
    it('mergeNonceFromEVMNode should update with nonce from EVM node (local<node)', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, patch_1.patch)(nonceManager, '_getTransactionCount', () => 19);
    ...
    it('getNextNonce should return nonces that are sequentially increasing', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(pendingNonce1).toEqual(10);
    ...
    it('provideNonce, nonce not provided. should return function results and commit nonce on successful execution of transaction', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(transactionResult.nonce).toEqual(10);
        expect(currentNonceFromMemory).toEqual(10);
    }));
    it('provideNonce, nonce not provided. should remove all pendingNonces greater or equal should function fail', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(expectedNonce).toEqual(9);
        const pendingNonce1 = yield nonceManager.getNextNonce(exampleAddress);
        expect(pendingNonce1).toEqual(10);
        const testFunction = (_nonce) => __awaiter(void 0, void 0, void 0, function* () {
...
describe("EVMNodeService was previously a singleton. Let's prove that it no longer is.", () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const provider1 = new ethers_1.providers.StaticJsonRpcProvider('http://127.0.0.1:8545/');
        nonceManager1.declareOwnership(handle);
        yield nonceManager1.init((address) => __awaiter(void 0, void 0, void 0, function* () { return (yield provider1.getTransactionCount(address)) - 1; }));
        nonceManager2 = new evm_nonce_1.EVMNonceManager('avalanche', 56, dbPath, 60, 60);
        nonceManager2.declareOwnership(handle);
        const provider2 = new ethers_1.providers.StaticJsonRpcProvider('http://127.0.0.1:8545/');
        yield nonceManager2.init((address) => __awaiter(void 0, void 0, void 0, function* () { return (yield provider2.getTransactionCount(address)) - 1; }));
    }));
    afterAll(() => __awaiter(void 0, void 0, void 0, function* () {
