...
exports.GrpcWebError = exports.GrpcWebImpl = exports.MsgUpdateParamsDesc = exports.MsgBidDesc = exports.MsgDesc = exports.MsgClientImpl = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgBidResponse = exports.MsgBid = void 0;
/* eslint-disable */
...
exports.MsgUpdateParams = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.params !== undefined) {
            auction_1.Params.encode(message.params, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
