...
describe('GET /chain/tokens', () => {
    ...
    it('should return 200 when retrieving ethereum-goerli tokens, s parameter provided', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(app_1.gatewayApp)
            .get(`/chain/tokens`)
            .query({
            chain: 'ethereum',
    ...
    it('should return 503 when retrieving tokens for invalid chain', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(app_1.gatewayApp)
            .get(`/chain/tokens`)
            .query({
            chain: 'unknown',
