...
exports.resolveDBPath = exports.ConfigManagerV2 = exports.ConfigurationNamespace = exports.percentRegexp = exports.initiateWithTemplate = exports.deepCopy = exports.ConfigRootSchemaPath = void 0;
...
class ConfigManagerV2 {
    static getInstance() {
        if (!ConfigManagerV2._instance) {
            ...
            const listsPath = path_1.default.join(ConfigDir, 'lists');
            if (!fs_1.default.existsSync(listsPath)) {
                fs_extra_1.default.copySync(path_1.default.join(ConfigTemplatesDir, 'lists'), listsPath);
            }
...
function resolveDBPath(oldPath) {
    if (oldPath.charAt(0) === '/')
        return oldPath;
