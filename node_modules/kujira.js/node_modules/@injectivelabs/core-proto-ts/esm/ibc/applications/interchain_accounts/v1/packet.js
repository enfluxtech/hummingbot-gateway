...
export const InterchainAccountPacketData = {
    ...
    create(base) {
        return InterchainAccountPacketData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseInterchainAccountPacketData();
...
export const CosmosTx = {
    ...
    fromJSON(object) {
        return { messages: Array.isArray(object === null || object === void 0 ? void 0 : object.messages) ? object.messages.map((e) => Any.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.messages) {
    ...
    create(base) {
        return CosmosTx.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseCosmosTx();
