...
type QueryConsensusStateHeights = {
  readonly methodName: string;
  readonly service: typeof Query;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof ibc_core_client_v1_query_pb.QueryConsensusStateHeightsRequest;
  readonly responseType: typeof ibc_core_client_v1_query_pb.QueryConsensusStateHeightsResponse;
};
...
export class Query {
  ...
  static readonly ConsensusStateHeights: QueryConsensusStateHeights;
...
export class QueryClient {
  ...
  consensusStateHeights(
    requestMessage: ibc_core_client_v1_query_pb.QueryConsensusStateHeightsRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: ibc_core_client_v1_query_pb.QueryConsensusStateHeightsResponse|null) => void
  ): UnaryResponse;
  consensusStateHeights(
    requestMessage: ibc_core_client_v1_query_pb.QueryConsensusStateHeightsRequest,
    callback: (error: ServiceError|null, responseMessage: ibc_core_client_v1_query_pb.QueryConsensusStateHeightsResponse|null) => void
