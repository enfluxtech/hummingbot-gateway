...
export const SignatureDescriptors = {
    ...
    create(base) {
        return SignatureDescriptors.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseSignatureDescriptors();
        message.signatures = ((_a = object.signatures) === null || _a === void 0 ? void 0 : _a.map((e) => SignatureDescriptor.fromPartial(e))) || [];
        return message;
    },
};
...
export const SignatureDescriptor = {
    ...
    create(base) {
        return SignatureDescriptor.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseSignatureDescriptor();
...
export const SignatureDescriptor_Data = {
    ...
    create(base) {
        return SignatureDescriptor_Data.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseSignatureDescriptor_Data();
...
export const SignatureDescriptor_Data_Single = {
    ...
    create(base) {
        return SignatureDescriptor_Data_Single.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseSignatureDescriptor_Data_Single();
...
export const SignatureDescriptor_Data_Multi = {
    ...
    create(base) {
        return SignatureDescriptor_Data_Multi.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseSignatureDescriptor_Data_Multi();
        message.bitarray = (object.bitarray !== undefined && object.bitarray !== null)
            ...
            : undefined;
        message.signatures = ((_a = object.signatures) === null || _a === void 0 ? void 0 : _a.map((e) => SignatureDescriptor_Data.fromPartial(e))) || [];
        return message;
    },
};
