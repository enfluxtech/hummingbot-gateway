...
export const ContractRegistrationRequestProposal = {
    ...
    create(base) {
        return ContractRegistrationRequestProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseContractRegistrationRequestProposal();
...
export const BatchContractRegistrationRequestProposal = {
    ...
    create(base) {
        return BatchContractRegistrationRequestProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseBatchContractRegistrationRequestProposal();
        ...
        message.contractRegistrationRequests =
            ((_c = object.contractRegistrationRequests) === null || _c === void 0 ? void 0 : _c.map((e) => ContractRegistrationRequest.fromPartial(e))) || [];
        return message;
    },
};
...
export const BatchContractDeregistrationProposal = {
    ...
    create(base) {
        return BatchContractDeregistrationProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseBatchContractDeregistrationProposal();
...
export const ContractRegistrationRequest = {
    ...
    create(base) {
        return ContractRegistrationRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const BatchStoreCodeProposal = {
    ...
    create(base) {
        return BatchStoreCodeProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseBatchStoreCodeProposal();
        message.title = (_a = object.title) !== null && _a !== void 0 ? _a : "";
        message.description = (_b = object.description) !== null && _b !== void 0 ? _b : "";
        message.proposals = ((_c = object.proposals) === null || _c === void 0 ? void 0 : _c.map((e) => StoreCodeProposal.fromPartial(e))) || [];
        return message;
    },
};
