...
export class MsgInfo extends jspb.Message {
  ...
  setMsg(value?: tendermint_consensus_types_pb.Message): void;
...
export class WALMessage extends jspb.Message {
  ...
  setEventDataRoundState(value?: tendermint_types_events_pb.EventDataRoundState): void;
  ...
  setTimeoutInfo(value?: TimeoutInfo): void;

  hasEndHeight(): boolean;
  clearEndHeight(): void;
  getEndHeight(): EndHeight | undefined;
  setEndHeight(value?: EndHeight): void;
