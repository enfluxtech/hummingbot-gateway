...
describe('Test EVMNonceManager', () => {
    ...
    it('getNonce reads nonce from node, commits, then reads nonce from memory', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield evmNonceManager.init((address) => __awaiter(void 0, void 0, void 0, function* () {
            return yield new ethers_1.providers.StaticJsonRpcProvider('http://127.0.0.1:8545/').getTransactionCount(address);
        }));
    ...
    it('commits to the same address on different chains should have separate nonce values', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield ethereumNonceManager.init((address) => __awaiter(void 0, void 0, void 0, function* () {
            return (yield new ethers_1.providers.StaticJsonRpcProvider('').getTransactionCount(address)) - 1;
        }));
        yield avalancheNonceManager.init((address) => __awaiter(void 0, void 0, void 0, function* () {
            return (yield new ethers_1.providers.StaticJsonRpcProvider('').getTransactionCount(address)) - 1;
        }));
