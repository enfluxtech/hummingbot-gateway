...
export declare const isStableSwapSupported: (chainId: number | undefined) => chainId is ChainId.BSC | ChainId.BSC_TESTNET;
export declare const STABLE_SUPPORTED_CHAIN_IDS: readonly [ChainId.BSC, ChainId.BSC_TESTNET];
